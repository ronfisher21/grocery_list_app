...
- שם המוצר עשוי להכיל מספר בתחילתו או בסופו המציין כמות (למשל "3 ביצים", "חלב 2"). התעלם מהמספר לחלוטין וסווג לפי שם המוצר בלבד. דוגמאות: "3 ביצים" -> מוצרי חלב וביצים, "2 לחמניות" -> לחם, "5 תפוחים" -> ירקות ופירות.
"""
