...
- בשר עוף ודגים: שניצל, נקניקיות, קבב, המבורגר, חזה עוף, כרעיים, דג, סלמון, טונה, כבד, בשר טחון, אנטריקוט, פרגית
- מוצרים יבשים ושימורים: טחינה, חומוס (קופסה), זיתים, קורנפלקס, שיבולת שועל, אורז, פסטה, עדשים, שעועית, גרנולה, ריבה, דבש, שמן, חומץ
